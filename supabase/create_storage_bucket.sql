-- ============================================
-- Set Up Profile Assets Storage Bucket Policies
-- ============================================
-- IMPORTANT: Create the bucket FIRST via Supabase Dashboard:
...
-- Step 1: Enable Row Level Security on storage.objects (if not already enabled)
ALTER TABLE storage.objects ENABLE ROW LEVEL SECURITY;

-- Step 2: Drop existing policies if they exist (to allow re-running this script)
